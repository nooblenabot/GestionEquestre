...
namespace GestionEquestre.Ge.Entities
{
    ...
    public sealed class CorEtabRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Fr Siret"), Column("FR_Siret"), Size(9)]
        public String FrSiret
        {
            get { return Fields.FrSiret[this]; }
            set { Fields.FrSiret[this] = value; }
        }
