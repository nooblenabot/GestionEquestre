...
namespace GestionEquestre.Ge.Entities
{
    ...
    [ConnectionKey("GE"), DisplayName("Code Lfc"), InstanceName("Code Lfc"), TwoLevelCached]
    [ReadPermission("Ge:CODE_LFC:Read")]
    [InsertPermission("Ge:CODE_LFC:Insert")]
    [UpdatePermission("Ge:CODE_LFC:Update")]
    [DeletePermission("Ge:CODE_LFC:Delete")]
    //[LookupScript("Ge.CodeLfc")]
    public sealed class CodeLfcRow : Row, IIdRow, INameRow
    {        
            #region Id
