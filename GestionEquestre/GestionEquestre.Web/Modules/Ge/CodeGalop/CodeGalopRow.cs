...
namespace GestionEquestre.Ge.Entities
{
    ...
    [ConnectionKey("GE"), DisplayName("Code Galop"), InstanceName("Code Galop"), TwoLevelCached]
    [ReadPermission("Ge:CODE_GALOP:Read")]
    [InsertPermission("Ge:CODE_GALOP:Insert")]
    [UpdatePermission("Ge:CODE_GALOP:Update")]
    [DeletePermission("Ge:CODE_GALOP:Delete")]
    [LookupScript("Ge.CodeGalop")]
    public sealed class CodeGalopRow : Row, IIdRow, INameRow
    {        
            #region Id
